...
namespace AqieHistoricaldataBackend.Test.Atomfeed
{
    public class AWSS3BucketServiceTests
    {
        ...
        public async Task WriteCsvToAwsS3Bucket_StandardBranch_DefaultDownloadType_CallsHourlyExport()
        {
            ...
            var result = await CreateService().WriteCsvToAwsS3BucketAsync(new List<FinalData>(), data, "Unknown");
        ...
        public async Task WriteCsvToAwsS3Bucket_StandardBranch_DailyDownloadType_CallsDailyExport()
        {
            ...
            var result = await CreateService().WriteCsvToAwsS3BucketAsync(finalList, data, "Daily");
        ...
        public async Task WriteCsvToAwsS3Bucket_StandardBranch_GeneratesCorrectS3Key()
        {
            ...
            await CreateService().WriteCsvToAwsS3BucketAsync(finalList, data, "Hourly");
        ...
        public async Task WriteCsvToAwsS3Bucket_StandardBranch_CallsUploadWithCorrectBucket()
        {
            ...
            await CreateService().WriteCsvToAwsS3BucketAsync(new List<FinalData>(), data, "Hourly");
        ...
        public async Task WriteCsvToAwsS3Bucket_DataSelectorHourly_SingleDownload_HourlyType_CallsDataSelectionExport()
        {
            ...
            var result = await CreateService().WriteCsvToAwsS3BucketAsync(finalList, data, "Hourly");
        ...
        public async Task WriteCsvToAwsS3Bucket_MissingBucketName_ReturnsEmpty()
        {
            ...
            var result = await CreateService()
                .WriteCsvToAwsS3BucketAsync(new List<FinalData>(), new QueryStringData(), "Hourly");
        ...
        public async Task WriteCsvToAwsS3Bucket_DailyExportThrows_ReturnsEmpty()
        {
            ...
            var result = await CreateService().WriteCsvToAwsS3BucketAsync(new List<FinalData>(), data, "Daily");
        ...
        public async Task WriteCsvToAwsS3Bucket_AnnualExportThrows_ReturnsEmpty()
        {
            ...
            var result = await CreateService().WriteCsvToAwsS3BucketAsync(new List<FinalData>(), data, "Annual");
        ...
        public async Task WriteCsvToAwsS3Bucket_OnException_LogsErrorMessageAndStackTrace()
        {
            ...
            _loggerMock.Verify(
                x => x.Log(
                    LogLevel.Error,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, _) => v.ToString()!.Contains("writecsvtoawss3bucket", StringComparison.OrdinalIgnoreCase)),
                    It.IsAny<Exception>(),
