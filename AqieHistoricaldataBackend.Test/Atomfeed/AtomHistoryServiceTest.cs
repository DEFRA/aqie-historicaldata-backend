...
namespace AqieHistoricaldataBackend.Test.Atomfeed
{
    public class AtomHistoryServiceTests
    {
        ...
        private readonly Mock<IAtomDataSelectionPresignedUrlMail> _presignedUrlMailMock = new();
        private readonly Mock<IAtomDataSelectionNonAurnNetworks> _nonAurnNetworksMock = new();
        private readonly Mock<IAtomDataSelectionPollutantMaster> _pollutantMasterMock = new();
        private readonly Mock<IAtomDataSelectionPollutantDataSource> _pollutantDataSourceMock = new();
        ...
        private AtomHistoryService CreateService(HttpClient? client = null)
        {
            ...
            return new AtomHistoryService(
                ...
                _presignedUrlMailMock.Object,
                _nonAurnNetworksMock.Object,
                _pollutantMasterMock.Object,
                _pollutantDataSourceMock.Object
            );
        }
        ...
        public async Task GetAtomDataSelectionJobStatusdata_ReturnsNull_WhenJobIdIsNull()
        {
            ...
            _dataSelectionJobStatusMock
                ...
                .ReturnsAsync((JobInfoDto?)null);   // ← fixed: nullable cast
